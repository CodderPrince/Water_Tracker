...
import 'addWater3.dart';
import 'appBar3.dart';

class WaterTracker3 extends StatefulWidget {
  const WaterTracker3({super.key});

  @override
  State<WaterTracker3> createState() => _WaterTracker3State();
}

class _WaterTracker3State extends State<WaterTracker3> {
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    AddWater3(amount: 1000, onClick: () => _waterAdd(1000)),
                  ],
                ),
              ),
              const SizedBox(height: 40),
